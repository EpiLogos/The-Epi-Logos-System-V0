...
const defaultSubsystems: SubsystemData[] = [
  { id: 0, name: "Anuttara", imagePath: "/ui-system/anuttara-hex.png", color: "#ffffff", description: "The absolute, beyond all categories" },
  { id: 1, name: "Paramasiva", imagePath: "/ui-system/paramasiva-hex.png", color: "#22c55e", description: "Pure consciousness, formless awareness" },
  { id: 2, name: "Parashakti", imagePath: "/ui-system/parashakti-hex.png", color: "#3b82f6", description: "Dynamic creative power" },
  { id: 5, name: "Epii", imagePath: "/ui-system/epii-hex.png", color: "#8b5cf6", description: "Meta-rational discourse, beyond logic" },
  { id: 4, name: "Nara", imagePath: "/ui-system/nara-hex.png", color: "#ef4444", description: "Individual consciousness, the experiencer" },
  { id: 3, name: "Mahamaya", imagePath: "/ui-system/mahamaya-hex.png", color: "#f59e0b", description: "The great illusion, cosmic manifestation" }
];
