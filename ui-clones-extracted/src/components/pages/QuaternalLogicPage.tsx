        ...
        >
          ...
          <div className="flex-1 flex flex-col relative">
            ...
            <div className={cn(
              ...
              isTransitioning 
                ? "page-container-quaternal-expanded"  // QUATERNAL LOGIC SPECIFIC: Expand during page transitions
                : "h-[60vh]"
            )}>
              ...
              >
                ...
                {currentPage === 0 && (
                  <img 
                    src="/Gemini_Generated_Image_ctzwt7ctzwt7ctzw (1).png" 
                ...
                {currentPage === 1 && (
                  ...
                  >
                    <img 
                      src="/Gemini_Generated_Image_8esm0e8esm0e8esm (1).png" 
