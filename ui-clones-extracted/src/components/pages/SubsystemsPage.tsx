...
import { useInterPageTransition } from '../../hooks/useInterPageTransition';


// Use relative paths for images  
const image0 = '/src/assets/images/anuttara-icon.png';
const image1 = '/src/assets/images/paramasiva-icon.png';
const image2 = '/src/assets/images/parashakti-icon.png';
const image3 = '/src/assets/images/mahamaya-icon.png';
const image4 = '/src/assets/images/nara-icon.png';
const image5 = '/src/assets/images/epii-icon.png';
...
export const SubsystemsPage: React.FC = () => {
  ...
  const handleBackToMain = () => {
    window.location.href = '/epi-logos';
  };
